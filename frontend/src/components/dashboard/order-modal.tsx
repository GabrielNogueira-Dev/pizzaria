          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <p className="text-lg font-semibold">Mesa <span className="text-md bg-brand-primary px-2 py-1 rounded-sm">{order.table}</span></p>
              </div>
              <div>
                        ...
                        <div className="flex justify-between items-start">
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-400 mt-2">
                                Subtotal: {(subtotal / 100).toLocaleString("pt-BR",{
                                    style:"currency",
                                    currency:"BRL"  
                                }) }                 
                            </p>
